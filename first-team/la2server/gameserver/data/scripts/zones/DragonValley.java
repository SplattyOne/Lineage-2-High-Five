...
public class DragonValley implements ScriptFile, OnPlayerExitListener
{
	...
	private static FastMap<Player, Integer> inzone = new FastMap<Player, Integer>();
	...
	public class ZoneListener implements OnZoneEnterLeaveListener
	{
		...
		{
			if(cha.isPlayer() && inzone.containsKey(cha.getPlayer()))
			{
				if(!_isActive)
